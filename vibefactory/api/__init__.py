"""
Módulo de la API de VibeFactory.

Proporciona endpoints para la orquestación de agentes IA.
"""
...
async def create_project(project: ProjectRequest):
    ...
    try:
        ...
        # Aquí iría la lógica para generar tareas usando el Planificador
        # Por ahora, usamos tareas de ejemplo
        tasks = [
            {
                "id": 1,
...
async def generate_task_code(project_id: str, task_id: int):
    ...
    try:
        ...
        return {"status": "success", "task_id": task_id, "code": generated_code}
...
# Ejemplo de uso:
# uvicorn vibefactory.api:app --reload
